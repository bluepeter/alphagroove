...
export const mapRawDataToTrade = (
  ...
  return {
    ...
    isStopLossLlmBased: rawTradeData.isStopLossLlmBased as boolean | undefined,
    isProfitTargetLlmBased: rawTradeData.isProfitTargetLlmBased as boolean | undefined,
